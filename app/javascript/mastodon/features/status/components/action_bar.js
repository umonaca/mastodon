  ...
  render () {
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        {show_quote_button && <div className='detailed-status__button'><IconButton disabled={!publicStatus} title={!publicStatus ? intl.formatMessage(messages.cannot_quote) : intl.formatMessage(messages.quote)} icon='quote-right' onClick={this.handleQuoteClick} /></div>}
